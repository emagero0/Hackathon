#!/bin/bash
# Script to test the Business Central Web Service integration with updated endpoints
...
echo -e "${YELLOW}Testing Business Central Web Service integration for Job No: ${JOB_NO}${NC}"
