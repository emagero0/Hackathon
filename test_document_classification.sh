#!/bin/bash
# Script to test the document classification and verification flow
...
echo -e "${YELLOW}Testing document classification and verification flow for Job No: ${JOB_NO}${NC}"
